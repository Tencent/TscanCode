 ...
 * @param isStrict , if false, <= and >= would be recoginized opposite
 */
bool isOppositeCond(bool isNot, bool cpp, const Token * const cond1, const Token * const cond2, const std::set<std::string> &constFunctions, bool isStrict = true);
