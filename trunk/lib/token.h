...
public:
	...
	// TSC:from TSC 20140408
	void setfuncinfo(std::string info)
	{
		funcinfo="";
		funcinfo=info;
	}
	std::string getfuncinfo() const
	{
		return funcinfo;
	}
	 ...
	 * @param foramt, format the codes with indent
     ...
     */
    std::string stringifyList(bool varid, bool attributes, bool linenumbers, bool linebreaks, bool files, bool format, const std::vector<std::string>* fileNames = 0, const Token* end = 0) const;
