...
std::string MathLib::incdec(const std::string & var, const std::string & op)
{
    ...
    throw InternalError(0, std::string("Unexpected operation '") + op + "' in MathLib::incdec(). Please report this to TscanCode developers.");
}
...
std::string MathLib::calculate(const std::string &first, const std::string &second, char action)
{
    ...
    default:
        throw InternalError(0, std::string("Unexpected action '") + action + "' in MathLib::calculate(). Please report this to TscanCode developers.");
    }
}
