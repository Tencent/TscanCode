...
{
    reportError(tok, Severity::error, ErrorType::None, "multiComparePatternError",
...
{
    reportError(tok, Severity::warning, ErrorType::None, "simplePatternError",
...
{
    reportError(tok, Severity::error, ErrorType::None, "complexPatternError",
...
{
    reportError(tok, Severity::error, ErrorType::None, "missingPercentCharacter",
...
{
    reportError(tok, Severity::error, ErrorType::None, "unknownPattern",
...
{
    reportError(tok, Severity::style, ErrorType::None, "redundantNextPrevious",
...
{
    reportError(tok, Severity::error, ErrorType::None, "orInComplexPattern",
...
{
    reportError(tok, Severity::warning, ErrorType::None, "extraWhitespaceError",
