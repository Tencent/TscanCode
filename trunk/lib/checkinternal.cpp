 ...
 */
#pragma once	//For Debug IntelliSense: PCH 警告: 标头停止点不能位于宏或 #if 块中。未生成 Intellisense PCH 文件 2015_01_04
#ifndef NDEBUG
...
{
    reportError(tok, Severity::warning, "CheckInternal","simplePatternError",
...
{
    reportError(tok, Severity::error, "CheckInternal","complexPatternError",
...
{
    reportError(tok, Severity::error,"CheckInternal", "missingPercentCharacter",
...
{
    reportError(tok, Severity::error, "CheckInternal","unknownPattern",
...
{
    reportError(tok, Severity::style,"CheckInternal", "redundantNextPrevious",
