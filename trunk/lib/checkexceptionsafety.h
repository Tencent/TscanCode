...
private:
    ...
    void destructorsError(const Token * const tok) {
        reportError(tok, Severity::error,"exceptionsafety", "exceptThrowInDestructor", "Exception thrown in destructor.");
    }

    void deallocThrowError(const Token * const tok, const std::string &varname) {
        reportError(tok, Severity::warning, "exceptionsafety","exceptDeallocThrow", "Exception thrown in invalid state, '" +
                    varname + "' points at deallocated memory.");
    }

    void rethrowCopyError(const Token * const tok, const std::string &varname) {
        reportError(tok, Severity::style,"exceptionsafety", "exceptRethrowCopy",
    ...
    void catchExceptionByValueError(const Token *tok) {
        reportError(tok, Severity::style,"exceptionsafety",
