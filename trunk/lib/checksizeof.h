...
class TSCANCODELIB CheckSizeof : public Check {
public:
    ...
    void runChecks(const Tokenizer* tokenizer, const Settings* settings, ErrorLogger* errorLogger) {
		...
		checkSizeof.checkSizeofForPointerSize2();//from TSC1.0 
    ...
    void runAnalysis(const Tokenizer* tokenizer, const Settings* settings, ErrorLogger* errorLogger);
	...
	void checkSizeofForPointerSize2();//from TSC1.0
