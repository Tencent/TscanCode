...
class TSCANCODELIB CheckType : public Check {
public:
    ...
    void runChecks(const Tokenizer *tokenizer, const Settings *settings, ErrorLogger *errorLogger) {
		...
		checkType.checkIntegerMultiply();
		checkType.checkUnsignedMinus();
	...
	void checkIntegerMultiply();
	void checkUnsignedMinus();
private:

	bool IsExprIntType(const Token* tok);
	bool IsExprUnsigned(const Token* tok);
	void IntegerMultiplyOverflowError(const Token *tok);
	void UnsignedMinusError(const Token *tok);
