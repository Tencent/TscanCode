        ...
        const std::string &funcname)
{
	...
	ErrorLogger::ErrorMessage errmsg(locationList, Severity::style, "The function '" + funcname + "' is never used.", ErrorType::None, "unusedFunction", false);
	errmsg.SetWebIdentity(funcname);
    if (errorLogger)
