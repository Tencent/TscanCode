...
class TSCANCODELIB CheckBool : public Check {
public:
    ...
    void runSimplifiedChecks(const Tokenizer *tokenizer, const Settings *settings, ErrorLogger *errorLogger) {
		...
		checkBool.checkComparisonWithBool();
#ifdef TSCANCODE_RULE_OPEN
...
private:
	bool IsBoolExpression(const Token* tok);
    // Error messages..
	...
	void comparisonWithBoolError(const Token *tok, const std::string &expression);
